...
| [temper.cpp](https://github.com/craigsapp/midifile/blob/master/tools/temper.cpp) | Split a single-timbre MIDI file into 12 channels, one for each pitch class.  Then apply pitch bends to turn each channel to a specific temerament. This method should work on all synthesizers. |
